...
class GUI(Frame):
    ...
    def initUI(self):
        ...
        inputButton = Button(iFrame, text="Choose", command=lambda:self.chooseDir(inputEntry))
        ...
        outputButton = Button(oFrame, text="Choose", command=lambda:self.chooseDir(outputEntry))
        ...
        okButton = Button(self, text="Stack!")
        okButton.pack(side=RIGHT)

    def chooseDir(self,entry):
